...
import prefuse.demos.curso.TreeReader;
...
public class TreeMap extends Display {
    ...
    public static final String TREE_CHI = "G:\\Documents and Settings\\Juanjo\\Escritorio\\Curso prefuse\\workspace\\prefuse\\data\\turkey2010_players.csv";
    ...
    public TreeMap(Tree t, String label) {
        ...
        /*** ESTABLECER ACTIONS  ***/
        // Leaf node size
        ActionList sizeActionList = new ActionList();
        //final SizeAction sizeAction = new SizeAction(treeNodes, 500);
        DataSizeAction sizeAction = new DataSizeAction(treeNodes,"weight");
        sizeAction.setIs2DArea(false); // <-- counterintuitive to me
        sizeActionList.add(sizeAction);
        //m_vis.putAction("size", sizeActionList);
        ...
        /*** INICIALIZAR DISPLAY Y CONTROLES***/
    ...
    public static Tree createTree(String datafile){
    	try{
    ...
    public static class FillColorAction extends ColorAction {
        private ColorMap cmap = new ColorMap(
            ColorLib.getInterpolatedPalette(10,
                ColorLib.rgb(150,150,150), ColorLib.rgb(0,0,0)), 0, 50);
            ...
            if ( item instanceof NodeItem ) {
                ...
                if ( nitem.getChildCount() > 0 ) {
                    ...
                    if ( m_vis.isInGroup(item, Visualization.SEARCH_ITEMS) )
                        ...
                        return cmap.getColor(nitem.getInt("color"));
                }
            } else {
