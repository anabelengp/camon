...
public class RadialGraphView extends Display {
    ...
    public RadialGraphView(Graph g, String label) {
        ...
        //BalloonTreeLayout treeLayout = new BalloonTreeLayout(tree, 20);
    ...
    public static void main(String argv[]) {
        String infile_nodes = DATA_FILE_NODES;
        String infile_arcs = DATA_FILE_ARCS;
        String label = "Label";
        ...
        frame.setContentPane(demo(infile_nodes, infile_arcs, label));
        frame.pack();
        frame.setVisible(true);
    }
    
    public static JPanel demo(String datafile_nodes, String datafile_arcs, final String label) {
        Graph g = null;
        try {
        	Table table_nodes = new CSVTableReader().readTable(datafile_nodes);
        	Table table_arcs = new CSVTableReader().readTable(datafile_arcs);
        	
        	//New directed Graph
            g = new Graph(table_nodes, table_arcs, true, "Id", "Source", "Target");
        } catch ( Exception e ) {
            e.printStackTrace();
            System.exit(1);
        }
